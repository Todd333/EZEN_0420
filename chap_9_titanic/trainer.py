...
train_data=train.drop('Sirvived',axis=1)
...
train_Y =train2['Surviced']
test_X = test2[target_col]
test_Y =test2['Surviced']
...
print('The accuracy of the Decision Tree is ',
      metrics.accuracy_score((dt_prediction, test_Y)))
...
k_fold = kFold(n_sllits=10, shuffle=True, random_state=0)
